...
import { listReports } from '@/server/reports/store';
import { reportsListTag } from '@/features/reports/cache';
import ReportsPageClient from './_components/reports-page.client';

const getReports = unstable_cache(async () => listReports(), ['reports:list'], {
  tags: [reportsListTag()],
});
